...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'COYN', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学习生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://coyn.cc', // 网站地址
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'COYN', // 站点描述，被notion中的页面描述覆盖
